...
func NewMissionDevStack(scope constructs.Construct, id string, props *MissionDevStackProps) awscdk.Stack {
...
func main() {
	...
	NewMissionDevStack(app, "MissionDevStack", &MissionDevStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
...
func env() *awscdk.Environment {
	...
	return &awscdk.Environment{
		Account: jsii.String("617097471695"),
